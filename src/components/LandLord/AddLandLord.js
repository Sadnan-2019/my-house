...
<div className="form-control w-full max-w-lg">
  <label className="label">
    <span className="label-text font-bold text-1xl">Chose Who you are</span>
    
  </label>
  <select className="select select-bordered">
  
    <option id="landlord"> Land Lord</option>
    <option><a class="nav-link" href="#rentperson">Rent Person</a></option>
      ...
      <div className="grid lg:grid-cols-3 justify-items-center py-5">
        ...
        >
          <div className="flex items-center justify-center 	 gap-3   ">
            ...
            <div className=" ">
              <h2 className="text-xs font-bold "> Dhaka Metropolitan Police </h2>
            </div>
          </div>
...
<div className="  ">
           ...
           <Input variant="static" placeholder="Date of Birth" />
            ...
            <Input variant="static" placeholder="Occupation/Organization/Job Location" />
            <div className="flex items-center justify-items-center gap-5">
           ...
           <Input variant="static" placeholder="Passport (if you have) " />
            ...
            <p className="text-lg text-left mt-5 font-bold">Emergency Contact</p>
            <div className="flex items-center justify-items-center gap-5">
