...
const MyAppoinment = () => {
  ...
  return (
    <div>
      <section class="is-title-bar text-black  rounded-md px-3 py-3 mx-2 mt-2 bg-white shadow-md  ">
      ...
      <div className="grid sm:grid-sm-1 lg:grid-cols-3 gap-2    mx-2 mt-2   ">
        {/* [1,2,3,4,5,6].map(items=>) */}
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <div class="card h-full w-full  bg-white shadow-md  text-black mb-5 ">
            <div class="card-body">
        ...
        {/* <div class="card  bg-gradient-to-r border-2 border-red-700  from-green-400 to-blue-500 shadow-xl  text-white mb-5 mt-12">
          <div class="card-body">
            <div class="flex items-center   ">
              <div>
                <div class="avatar">
        ...
        <div class="card border-2 border-red-700  bg-gradient-to-r from-green-400 to-blue-500 shadow-xl  text-white mb-5 mt-12">
          <div class="card-body">
            <div class="flex items-center   ">
              <div>
                <div class="avatar">
